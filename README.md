...
**CODAH MUSIC** brings your music together in one sleek desktop experience. Stream from YouTube Music, browse Billboard charts, import your Spotify playlists, and manage your local library — all without switching apps.
...
The compiled app will be available under `build/windows/runner/Release/`.

---

## 📥 Download

Prefer not to build it yourself? Grab the latest release straight from the website:
